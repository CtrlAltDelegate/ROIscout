...
const Signup = ({ onLogin }) => {
  ...
  const inputCls = "w-full px-3 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-white text-sm placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent";
    ...
    >
      ...
      <div className="max-w-md w-full bg-slate-900 rounded-2xl shadow-2xl ring-1 ring-white/10 p-8">
        <div className="text-center mb-7">
          ...
          <p className="text-slate-400 text-sm mt-1">Start finding profitable rental markets</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="password" name="password" value={formData.password} onChange={handleChange} className={inputCls} required minLength="6" />
          </div>
          <div>
            <label className="block text-xs font-medium text-slate-400 mb-1.5">Confirm password</label>
            <input type="password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} className={inputCls} required minLength="6" />
          </div>
          <button
